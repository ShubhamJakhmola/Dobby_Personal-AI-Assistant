...
def get_assistant_name() -> str:
    """Return the configured assistant name, or 'Dobby' if not set."""
    return load_api_keys().get("assistant_name", "Dobby") or "Dobby"
...
def save_assistant_config(assistant_name: str, user_name: str) -> None:
    ...
    if CONFIG_FILE.exists():
        try:
            ...
            data = {}
    data["assistant_name"] = assistant_name.strip() or "Dobby"
...
def get_hud_style() -> str:
    ...
    about the same. Defaults to the head because that is the original default
